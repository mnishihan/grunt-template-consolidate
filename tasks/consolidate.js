...
module.exports = function(grunt) {
  ...
  grunt.registerMultiTask('consolidate', 'Generates html files from wide range of templates identified by file extensions', function(){
    var config = this;
    var data = this.data;
    ...
    var engineOptions = _.omit(options, 'variables', 'partialPath', 'engine');

    if (typeof vars === 'function' && vars.length == 0) {
        vars = vars();
        vars = _.merge(vars, engineOptions);
    }
    ...
    var getTemplateVars = function(src){
      ...
      if (typeof vars === 'function') {
        ...
        templateVars = _.merge(templateVars, engineOptions);
      }
